...
class policy_dispatch
{
    ...
    public:
        policy_dispatch(const sequential_execution_policy& seq) : seq_(seq), policy_(policy_type::SEQ) {}
        policy_dispatch(const parallel_execution_policy&   par) : par_(par), policy_(policy_type::PAR) {}
